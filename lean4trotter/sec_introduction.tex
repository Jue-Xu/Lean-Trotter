...
exp-Lipschitz lifts. Two transitive private axioms remain inside the
companion \href{https://github.com/Jue-Xu/Lean-BCH}{Lean-BCH} project:
the three-factor symmetric BCH quintic Taylor bridge (B1.c, supports L2/L3)
and the new five-factor palindromic septic identification (R$_7$,
supports L4). All other Lean-BCH content is fully sorry-free; the
three-factor symmetric BCH cubic identities and the two-factor
palindromic quintic remainder are theorems specialized to
$\mathbb{K} = \mathbb{R}$ and imported directly.
