...
The formalization comprises over 10\,500 lines of Lean~4 with zero
...
The three-factor symmetric BCH identities are imported directly from the
companion
\href{https://github.com/Jue-Xu/Lean-BCH}{Lean-BCH} project;
the project's remaining axioms (four, all encoding the
five-factor palindromic BCH expansion of the $S_4$ product) are well-defined
mathematical claims pending further Lean-BCH development.
\end{abstract}
