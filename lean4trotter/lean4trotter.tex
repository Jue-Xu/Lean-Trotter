...
refinement of Childs et al.'s (2021) heuristic prefactors; compounding
the single-step bound over $n$ steps yields a machine-checked
$O(1/n^4)$ convergence theorem, completing a verified hierarchy
$O(1/n) \to O(1/n^2) \to O(1/n^4)$.
The formalization spans over 12\,100 lines with zero \texttt{sorry}
axioms; the tight 4th-order Trotter bound is fully proved down to
\Lean's standard foundational axioms, while a finite-$t$ uniform
