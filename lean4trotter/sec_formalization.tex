...
The formalization is organized into 29~Lean source files, grouped by track
...
\leansrc{Suzuki4ViaBCH.lean}              & 855  & L1/L2/L3/L4 BCH-derived bounds \\
\midrule
\textbf{Total} & \textbf{10\,541} & \textbf{0 \texttt{sorry} axioms,
4 BCH-interface axioms} \\
\bottomrule
\end{tabular}
...
used in the Suzuki $S_4$ track. Build time for the full project is under
2~minutes on a standard laptop after \Mathlib oleans are cached
