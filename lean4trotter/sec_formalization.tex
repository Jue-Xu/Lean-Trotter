...
(2026-04-24); in particular, \texttt{suzuki5\_bch\_M4b\_RHS\_le\_t5\_of\_IsSuzukiCubic}
supplies the single-step $O(\abs{\tau}^5)$ payoff that anchors our
SLICE-1 bound \texttt{exists\_norm\_s4Func\_sub\_exp\_le\_t5}. Build time
for the full project is under 2~minutes on a standard laptop after
\Mathlib oleans are cached (\texttt{lake exe cache get}).
