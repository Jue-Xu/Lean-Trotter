...
We have presented, to our knowledge, the first machine-checked convergence
proof of the Lie--Trotter
product formula, together with the first formalized higher-order extensions
and
...
septic axioms gate only the optional Level~4 local small-$\tau$
($\tau^7$) refinement. The development covers:
\begin{itemize}
...
\begin{enumerate}
  ...
  \item \emph{Closing the two surviving Lean-BCH-side axioms.}
    ...
    only the optional Level~4 local small-$\tau$ bound with explicit
