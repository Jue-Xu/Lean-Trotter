...
standard first-order Trotterization error lemma as part of its correctness
proof. Our work extends this program to the product formulas themselves: to
our knowledge it provides the first machine-checked \emph{convergence} proof
of a product formula, and the first machine-checked higher-order and
commutator-scaling Trotter bounds.
